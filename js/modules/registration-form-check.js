				...
				_loginValidate: function(e) {
					...
					$.each(_inputs, function(index, val) {
						var input = $(val),
							...
							errorWithDescTooltip = $('<div class="error error--with-desc">Данный email уже занят</div>'),

							loginMsg = $('<div class="error-description"><p>Используйте другой email чтобы создать новый аккаунт.</p><p>Или воспользуйтесь <a href="#">восстановлением пароля</a>, чтобы войти на сайт.</p></div>');
